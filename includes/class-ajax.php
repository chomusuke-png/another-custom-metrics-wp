...
class ACM_Ajax {
    ...
    public function render_preview() {
        // Verificar permisos y nonce (opcional pero recomendado)
        if ( ! current_user_can( 'edit_posts' ) ) {
            wp_send_json_error( 'No permission' );
        }

        // Recoger datos del POST (Formulario en vivo)
        ...
        // Preparar Datos (Igual que en Shortcode)
        ...
        // Renderizar usando el Template Público
        ob_start();
