...
<div class="acm-metabox-wrapper" style="display: grid; gap: 15px;">
    ...
    <div style="background: #f9f9f9; padding: 15px; border: 1px solid #ddd; border-radius: 4px;">
        ...
        <div id="acm_image_wrapper"
            style="margin-bottom: 10px; text-align: center; min-height: 50px; display: <?php echo $image_url ? 'block' : 'none'; ?>;">
            <img id="acm_image_preview_tag" src="<?php echo esc_url($image_url); ?>"
        ...
        <div style="display: flex; gap: 10px; justify-content: center;">
            <button type="button" class="button"
                id="acm_upload_image_btn"><?php echo $image_url ? 'Cambiar Imagen' : 'Subir Imagen'; ?></button>
            <button type="button" class="button button-link-delete" id="acm_remove_image_btn"
                style="<?php echo $image_url ? '' : 'display:none;'; ?>">Quitar</button>
        </div>
    </div>

    <p>
        <label for="acm_value"><strong>Valor de la Métrica:</strong></label><br>
        <input type="text" id="acm_value" name="acm_value" value="<?php echo esc_attr($metric_value); ?>"
            style="width: 100%;" placeholder="Ej: 1500">
    </p>

    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
        <p style="margin: 0;">
            <label for="acm_prefix"><strong>Prefijo:</strong></label><br>
            <input type="text" id="acm_prefix" name="acm_prefix" value="<?php echo esc_attr($metric_prefix); ?>"
                style="width: 100%;" placeholder="Ej: +">
        </p>
        <p style="margin: 0;">
            <label for="acm_suffix"><strong>Sufijo:</strong></label><br>
            <input type="text" id="acm_suffix" name="acm_suffix" value="<?php echo esc_attr($metric_suffix); ?>"
                style="width: 100%;" placeholder="Ej: ud.">
        </p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 15px;">
        <p style="margin: 0;">
            ...
            <select id="acm_format" name="acm_format" style="width: 100%;">
                ...
                <option value="money_compact" <?php selected($metric_format, 'money_compact'); ?>>Moneda Compacta ($
                    1M)</option>
        ...
        <p style="margin: 0;">
            ...
            <input type="number" id="acm_decimals" name="acm_decimals"
                value="<?php echo esc_attr($metric_decimals); ?>" min="0" max="10" style="width: 100%;">
        </p>
    </div>
    ...
    <div style="display: grid; grid-template-columns: 2fr 1fr; gap: 15px;">
        ...
        <p style="margin: 0;">
            ...
            <input type="number" id="acm_duration" name="acm_duration"
                value="<?php echo esc_attr($metric_duration); ?>" step="0.1" min="0" style="width: 100%;">
        </p>
    </div>

    <p>
        <label for="acm_label"><strong>Etiqueta / Descripción:</strong></label><br>
        <input type="text" id="acm_label" name="acm_label" value="<?php echo esc_attr($metric_label); ?>"
            style="width: 100%;">
    </p>
    ...
    <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px;">
        <p style="margin: 0;">
            ...
            <input type="color" id="acm_color" name="acm_color"
                value="<?php echo esc_attr($metric_color ? $metric_color : '#0073aa'); ?>"
                style="width: 100%; height: 40px;">
        </p>
        <p style="margin: 0;">
            <label for="acm_bg_color">Fondo:</label><br>
            <input type="color" id="acm_bg_color" name="acm_bg_color"
                value="<?php echo esc_attr($metric_bg_color ? $metric_bg_color : '#ffffff'); ?>"
                style="width: 100%; height: 40px;">
        </p>
        <p style="margin: 0;">
            <label for="acm_border_color">Borde:</label><br>
            <input type="color" id="acm_border_color" name="acm_border_color"
                value="<?php echo esc_attr($metric_border_color ? $metric_border_color : '#e5e5e5'); ?>"
                style="width: 100%; height: 40px;">
        </p>
    </div>
